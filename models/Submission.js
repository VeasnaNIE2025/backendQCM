...
const Submission = sequelize.define('Submission', {
  ...
  fileType:     { type: DataTypes.STRING(50), allowNull: true },    // ← ថ្មី
  fileSize:     { type: DataTypes.INTEGER, allowNull: true },        // ← ថ្មី
  submittedAt:  { type: DataTypes.DATE, defaultValue: DataTypes.NOW },
  grade:        { type: DataTypes.INTEGER, allowNull: true },
  feedback:     { type: DataTypes.TEXT, allowNull: true },
  gradedAt:     { type: DataTypes.DATE, allowNull: true },
  status:       { type: DataTypes.ENUM('submitted','graded'), defaultValue: 'submitted' } // ← ថ្មី
